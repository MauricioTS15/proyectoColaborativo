...
urlpatterns = [
    ...
    path('proyectos/reg_proyecto', views.ProyectoCreateView.as_view(),
         name='registrar proyecto'),
    path('proyectos/<int:pk>', views.ProyectoDetailView.as_view(), name='proyecto'),
    path('proyectos/<int:proyecto_id>/mod_proyecto',
         views.mod_proyecto, name='modificar proyecto'),
    ...
    path('tareas/<int:tarea_id>/mod_tarea',
         views.mod_tarea, name='modificar tarea'),
